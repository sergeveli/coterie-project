...
POSTing and GETting JSON data can be tested by navigating into the project file where the backend resides, opening a terminal and entering the following commands: 
